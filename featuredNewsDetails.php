            ...
            <div class="col-md-12 col-sm-6 col-lg-12 col-md-12" id="items">
                <div class="row data-row" style="overflow: hidden;">
                    ...
                    <div class="col-md-12" id="page-title">
                        ...
                        <h5 class="ml-1" style="color: black;"><?= date('d M',strtotime($data['date'])).' '.date('Y')  ?></h5>
                    </div>
                    <!--Page Heading ends-->
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-7">
                                <img width="100%" src="admin/resources/newsCoverImages/<?=$data['cover_image']?>" alt="">
                            </div>
                    ...
                    <div class="col-md-12 mt-3">
                        <div class="row">
                            <div class="col-md-8" id="f-NewsDesc">
                                <pre id="f-NewsPre"><?=$data['description']?></pre>
                            </div>
